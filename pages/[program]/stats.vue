    ...
    <div>
        ...
        <ClientOnly>
            <div v-if="!errorDisplay && stats" class="flex flex-col bg-radial gap-8 pt-8 px-4 sm:px-12 md:px-24">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 *:w-full gap-8 w-full p-4">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 *:w-full gap-4 w-full p-4">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 *:w-full gap-4 w-full p-4">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 justify-center gap-4 w-full p-4">
